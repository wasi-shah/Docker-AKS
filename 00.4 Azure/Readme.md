...
- [Azure Compute](#azure-compute)
  - [Cloud Computing Types/Models](#cloud-computing-typesmodels)
    - [Public](#public)
    - [Private](#private)
    - [Hybrid](#hybrid)
  - [Compute Service Types/Models](#compute-service-typesmodels)
    - [Infrastructure as a service (IaaS)](#infrastructure-as-a-service-iaas)
    - [Platform as a service (PaaS)](#platform-as-a-service-paas)
    - [Software as a service (SaaS)](#software-as-a-service-saas)
    - [Serverless/Function as a Service.](#serverlessfunction-as-a-service)
  ...
  - [Azure data services](#azure-data-services)
    ...
    - [Azure managed Disks](#azure-managed-disks)
      - [Disk roles](#disk-roles)
        - [Data disk](#data-disk)
        - [OS disk](#os-disk)
        - [Temporary disk](#temporary-disk)
    - [Azure Container Storage](#azure-container-storage)
  - [Azure Storage redundancy/replication](#azure-storage-redundancyreplication)
    ...
    - [Redundancy in a secondary region](#redundancy-in-a-secondary-region)
      ...
      - [Read-access geo-redundant storage (RA-GRS) \& Read-access geo-zone-redundant storage (RA-GZRS)](#read-access-geo-redundant-storage-ra-grs--read-access-geo-zone-redundant-storage-ra-gzrs)
  - [Azure Storage Performance Tiers](#azure-storage-performance-tiers)
  - [Azure Storage Access Tier (Only available with standard storage)](#azure-storage-access-tier-only-available-with-standard-storage)
  - [Azure Storage Encryption](#azure-storage-encryption)
    - [1.	Microsoft-Managed-Keys (MMK)](#1microsoft-managed-keys-mmk)
    - [2.	Custom-Managed-Keys (CMK)](#2custom-managed-keys-cmk)
  - [Azure Storage Identity and access management](#azure-storage-identity-and-access-management)
    - [Access Keys](#access-keys)
    - [Shared Access Keys](#shared-access-keys)
    - [Microsoft Entra ID Integration](#microsoft-entra-id-integration)
  - [Azure Data Import/Export](#azure-data-importexport)
- [Azure Networking](#azure-networking)
  - [Azure DNS](#azure-dns)
  - [Azure Content Delivery Network](#azure-content-delivery-network)
  - [Azure load balancing services](#azure-load-balancing-services)
    - [Azure Traffic Manager](#azure-traffic-manager)
    - [Azure Load Balancer](#azure-load-balancer)
    - [Azure Application Gateway](#azure-application-gateway)
    - [Azure Front Door](#azure-front-door)
  - [Azure Virtual Network](#azure-virtual-network)
    - [Communication of Azure resources with the internet.](#communication-of-azure-resources-with-the-internet)
    ...
    - [Communication with on-premises resources.](#communication-with-on-premises-resources)
      - [Point-to-site virtual private network (VPN)](#point-to-site-virtual-private-network-vpn)
      - [Site-to-site VPN](#site-to-site-vpn)
      - [Azure ExpressRoute](#azure-expressroute)
    - [Virtual Network Gateway](#virtual-network-gateway)
    - [Security \& Filtering of network traffic.](#security--filtering-of-network-traffic)
      - [Network security groups](#network-security-groups)
      - [Network virtual appliances](#network-virtual-appliances)
    - [Routing of network traffic.](#routing-of-network-traffic)
    - [Integration with Azure services.](#integration-with-azure-services)
  - [Monitoring/Troubleshooting Azure Virtual Networks](#monitoringtroubleshooting-azure-virtual-networks)
    - [Network Watcher](#network-watcher)
      - [NSG diagnostics](#nsg-diagnostics)
      - [IP flow verify](#ip-flow-verify)
      - [Next hop](#next-hop)
      - [Network packet capture](#network-packet-capture)
      - [Connection Monitor](#connection-monitor)
    - [Topology Tool/Viewer](#topology-toolviewer)
