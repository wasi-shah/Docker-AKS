...
| ---------| ------------- | ------------- |
|  1 | command line -var and -var-file  |  values set by command for example <li> [terraform plan -var "resource_group_location=eastus"] <li> [terraform plan -var-file="prod.tfvars"] |
